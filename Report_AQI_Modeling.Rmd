...
# Model summaries outcome: ondansetron administration
...
results.table <- bind_cols(OR.TABLE,post.interval)
rownames(results.table) <- rownames(OR.TABLE)
save(results.table, file = "Results/Results7.0.Rdata")
```
...
# Model summaries outcome any antiemetic adminstration
