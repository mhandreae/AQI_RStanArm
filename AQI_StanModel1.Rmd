...
require(rstanarm)
load("Data/myAQI_cpt.Rdata")
formulaRS7.0 <- ond ~ pay + age_group + sex + ASA + anes_type + practice +
  (1 | cpt) + (1 + pay | prov)
...
stanfitS7.0 <- stan_glmer(formulaRS7.0, data = ccAQI_cpt, family = binomial, chains = 4, iter= 500, cores =4)

save(stanfitS7.0, file = "Results/stanfitS7.0.Rdata")
```