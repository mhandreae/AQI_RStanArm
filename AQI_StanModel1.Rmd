...
### Income median and insurance status as predictors with two random effects model
...
require(shinystan)
load("Data/myAQI_cpt.Rdata")
formulaR9.any <- any ~ income + pay + age_group + sex + ASA + 
  anes_type + practice + (1 | cpt) + (1 | prov)

stanfit9.any <- stan_glmer(formulaR9.any, data = ccAQI_cpt, family = binomial(link=logit), chains = 4, iter= 10, cores =4)
